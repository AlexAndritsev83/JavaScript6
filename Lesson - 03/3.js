...
function truncate(string, maxLength) {
    if (typeof string == 'string' && typeof maxLength == 'number') {
        if (string.length > maxLength) {
            let newString = string.slice(0, maxLength - '...'.length) + '...';
            return newString;
...
// console.log(truncate('Вот, что мне хотелось бы сказать на эту тему:', 44));
// console.log('Вот, что мне хотелось бы сказать на эту тему:'.length);
// console.log(truncate('Вот, что мне хотелось бы сказать на эту тему:', '21'));
