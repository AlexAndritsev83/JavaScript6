...
const compose = (...funcs) => {
   checkForFunction(...funcs)  

   const result = initialArg => funcs.reduceRight((acc, func) => func(acc) ? func(acc) : new Error ('One of the Arguments as function did not returned any value'), initialArg);
